...
# CONFIGURATION
# ------------------------------------------------------------------------------
SPOTIFY_CLIENT_ID = "abc1bfe40eec4abc8bff1a9099f5638e"
SPOTIFY_CLIENT_SECRET = "314a99b3663149c5b28c8b81b97c120c"
...
if __name__ == "__main__":
    file = INPUT_DIR / "charted_songs_part9.csv"  # Adjust per script instance
