...
# CONFIGURATION
# -----------------------------
PARTS_DIR = Path(r"Z:\Data_alexander\data\raw_data\Spotify\1980_2000_songs_artists\parts_charted_songs\more_normalized\spotify_track_info")
CSV_OUTPUT = PARTS_DIR / "charted_songs_1980_2000_second_fetch_normalized.csv"
PARQUET_OUTPUT = PARTS_DIR / "charted_songs_1980_2000_second_fetch_normalized.parquet"
