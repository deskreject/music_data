...
# CONFIGURATION
# ------------------------------------------------------------------------------
SPOTIFY_CLIENT_ID = "c19747895813431189fce075d9aa547c"
SPOTIFY_CLIENT_SECRET = "ebaa06e120294daf91d3f2d413b4ab1e"
...
if __name__ == "__main__":
    file = INPUT_DIR / "charted_songs_part10.csv"  # Adjust per script instance
