...
# CONFIGURATION
# ------------------------------------------------------------------------------
SPOTIFY_CLIENT_ID = "f9031e1a70a049778b6808aae02f296c"
SPOTIFY_CLIENT_SECRET = "244d47a400cd47d4b7aebf25b93ae51f"
...
if __name__ == "__main__":
    file = INPUT_DIR / "charted_songs_part7.csv"  # Adjust per script instance
