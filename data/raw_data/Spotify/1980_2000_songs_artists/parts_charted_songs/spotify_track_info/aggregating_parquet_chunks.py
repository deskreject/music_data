...
# CONFIGURATION
# -----------------------------
PARTS_DIR = Path(r"Z:\Data_alexander\data\raw_data\Spotify\1980_2000_songs_artists\parts_charted_songs\spotify_track_info")
CSV_OUTPUT = PARTS_DIR / "charted_songs_1980_2000_full.csv"
PARQUET_OUTPUT = PARTS_DIR / "charted_songs_1980_2000_full.parquet"
